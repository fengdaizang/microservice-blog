                        ...
                        <div class="fn-clear">
                            <nav class="pagination fn-right">
                                ...
                                <#list page.pages as pageNum>
                                    ...
                                    <#else>
                                    <a class="page-number" href="${request.contextPath}/article/mgr?pageNo=${pageNum}">${pageNum}</a>
                                    </#if>
                                </#list>
                                <#if page.pages?last != page.totalPage>
                                <span class="page-number">...</span>
                                <a href="${request.contextPath}/article/mgr?pageNo=${page.totalPage}" class="page-number">${page.totalPage}</a>
                                <a href="${request.contextPath}/article/mgr?pageNo=${page.next}" class="page-number">&raquo;</a>
                                </#if>
                            </nav>
                        </div>
                    </div>
